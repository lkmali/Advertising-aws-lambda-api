...
const envConfig: Env = {
    ...
    MONGO_DB_URL: process.env.MONGO_DB_URL??'mongodb+srv://laxman:9lsaIEOt2Ilw6gVt@cluster0.og0el.mongodb.net/sync-ai?retryWrites=true&w=majority&appName=Cluster0',
